...
export interface Database {
  public: {
    Tables: {
      profiles: {
        Row: { id: string; email: string; username: string | null; display_name: string | null; phase: 'dissonance' | 'uncertainty' | 'discovery'; level: '1.0' | '2.0' | '3.0'; active_pillars: string[]; onboarding_complete: boolean; subscription_tier: 'free' | 'pro'; founding_member: boolean; stripe_customer_id: string | null; stripe_subscription_id: string | null; subscription_plan: 'weekly' | 'monthly' | 'annual' | null; subscription_status: 'active' | 'trialing' | 'past_due' | 'canceled' | 'incomplete' | 'incomplete_expired' | 'unpaid' | 'paused' | null; subscription_current_period_end: string | null; pillar_scores: Json; legal_consent_complete: boolean; ai_processing_consent: boolean; terms_version: string | null; privacy_version: string | null; legal_accepted_at: string | null; created_at: string; updated_at: string };
        Insert: { id: string; email: string; username?: string | null; display_name?: string | null; phase?: 'dissonance' | 'uncertainty' | 'discovery'; level?: '1.0' | '2.0' | '3.0'; active_pillars?: string[]; onboarding_complete?: boolean; subscription_tier?: 'free' | 'pro'; founding_member?: boolean; stripe_customer_id?: string | null; stripe_subscription_id?: string | null; subscription_plan?: 'weekly' | 'monthly' | 'annual' | null; subscription_status?: 'active' | 'trialing' | 'past_due' | 'canceled' | 'incomplete' | 'incomplete_expired' | 'unpaid' | 'paused' | null; subscription_current_period_end?: string | null; pillar_scores?: Json; legal_consent_complete?: boolean; ai_processing_consent?: boolean; terms_version?: string | null; privacy_version?: string | null; legal_accepted_at?: string | null; created_at?: string; updated_at?: string };
        Update: { email?: string; username?: string | null; display_name?: string | null; phase?: 'dissonance' | 'uncertainty' | 'discovery'; level?: '1.0' | '2.0' | '3.0'; active_pillars?: string[]; onboarding_complete?: boolean; subscription_tier?: 'free' | 'pro'; founding_member?: boolean; stripe_customer_id?: string | null; stripe_subscription_id?: string | null; subscription_plan?: 'weekly' | 'monthly' | 'annual' | null; subscription_status?: 'active' | 'trialing' | 'past_due' | 'canceled' | 'incomplete' | 'incomplete_expired' | 'unpaid' | 'paused' | null; subscription_current_period_end?: string | null; pillar_scores?: Json; legal_consent_complete?: boolean; ai_processing_consent?: boolean; terms_version?: string | null; privacy_version?: string | null; legal_accepted_at?: string | null; updated_at?: string };
